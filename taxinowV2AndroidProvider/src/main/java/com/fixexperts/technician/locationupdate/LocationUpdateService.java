package com.fixexperts.technician.locationupdate;
...
import com.fixexperts.technician.MyReceiver;
import com.fixexperts.technician.R;
import com.fixexperts.technician.SettingActivity;
	...
	private class UploadTripLocationData extends
		...
		protected String doInBackground(String... params) {
			try {
				...
				//AppLog.Log("BEARING", bearing+"");
				AppLog.Log("request_id", "" + preferenceHelper.getRequestId()+"");
